...
parser.add_argument('--use_labeled_data', dest='use_labeled_data', type=bool, default=False, help='serpvise')


"""Arguments related to training"""
parser.add_argument('--loss_metric', dest='loss_metric', default='L1', help='L1, or L2')
parser.add_argument('--niter', dest='niter', type=int, default=50, help='# of iter at starting learning rate')
parser.add_argument('--lr', dest='lr', type=float, default=0.0001, help='initial learning rate for adam')#0.0002
...
parser.add_argument('--lambda_A', dest='lambda_A', type=float, default=101.0, help='# weights of A recovery loss')
parser.add_argument('--lambda_B', dest='lambda_B', type=float, default=101.0, help='# weights of B recovery loss')
parser.add_argument('--lambda_pair', dest='lambda_pair', type=float, default=101.0, help='# weights of pair recovery loss')
...
parser.add_argument('--save_latest_freq', dest='save_latest_freq', type=int, default=400, help='save the latest model every latest_freq sgd iterations (overwrites the previous latest model)')
